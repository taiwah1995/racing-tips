...
```
https://taiwah1995.github.io/racing-tips/?v=20260920p
```
...
- **Home**: list of tip archives (date + venue 沙田/快活谷 + race count + 馬膽 with colored place pills). Header subtitle is all-time banker WP P&L from every settled meeting in `data/wp-bets.json` (`☆ 累計盈利 $… ☆ (回報 ±…%)`, gold `.subtitle-profit`)
...
- **Cache bust**: `APP_DATA_VERSION` in `js/app.js` (currently `20260920p`) versions data fetches and asset URLs
